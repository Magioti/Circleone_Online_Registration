            ...
            ->schema([
                Card::make()
                    ->schema([
                        ...
                        TextInput::make('partner_identity')->label('No NIK/SIM/NIB')->required()->disabledOn('edit'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('partner_identity')->sortable()->searchable()->label('No NIK/SIM/NIB'),
